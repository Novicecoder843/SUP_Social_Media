...
//       [blocker_id, blocked_id]
//     );
//     return { message: `User ${check.message} unblock successfully` };
//   }
...
//     WHERE 
//       (blocker_id=$1 AND follower_id=$2)
//       OR
//       (blocker_id=$2 AND follower_id=$1)
//     `,
//     [blocker_id, blocked_id]
//   );

//   return { message: `User ${check.message} blocked successfully` };
// };
